	...
	<div class="container">
		<div class="row">
			<div class="col-md-6">
				...
				<p class="text-justify lead" style="font-weight:bold"> Bhutan Roja Tours & Treks is the place to discover the stunning beauty that resides in the tourism spots
                     of Bhutan. Our objective is to make it easier for you to enjoy all these amazing places.
...
<div class="container-fluid plan">
    <div class="row text-center">
        <h1  class="m-auto"><strong>Plan Your Tour Easily</strong></h1>
    </div>
    <div class="row text-center">
        <div class="col-md-4">
